...
public class Main {
    ...
    private void printHelp() {
        ...
        System.out.println("                - dates=[start-date],[end-date]: 지정한 기간동안의 변경 정보를 수집합니다. 순차적으로 수집합니다.");
        System.out.println("                - dates=[date]: 특정날짜(하루) 동안의 변경 정보를 수집합니다.");
        System.out.println("                - cid-file=[file-name]: cid 목록파일을 제공하여 지정된 cid에 대한 정보만 선택적으로 수집합니다. (주의). `생태관광`의 경우 동작하지 않습니다.");
        System.out.println("                - cid=[cid1],[cid2],..,[cidn]: cid 텍스트 목록을 제공하여 지정된 cid에 대한 정보만 선택적으로 수집합니다. (주의). `생태관광`의 경우 동작하지 않습니다.");
